...
import edu.gdpu.zero.module.member.controller.app.auth.vo.AppAuthResetPasswordReqVO;
import edu.gdpu.zero.module.member.controller.app.auth.vo.AppAuthUpdatePasswordReqVO;
 ...
 * @author 宋天
 */
@Import({MemberAuthServiceImpl.class, ZeroRedisAutoConfiguration.class})
