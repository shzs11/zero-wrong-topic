package edu.gdpu.zero.module.member.service.user;
...
import edu.gdpu.zero.module.member.controller.app.user.vo.AppUserUpdateMobileReqVO;
...
import edu.gdpu.zero.module.member.service.auth.MemberAuthServiceImpl;
 ...
 * @author 宋天
 */
@Import({MemberUserServiceImpl.class, ZeroRedisAutoConfiguration.class})
