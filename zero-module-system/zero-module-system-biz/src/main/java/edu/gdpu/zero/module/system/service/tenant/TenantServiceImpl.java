...
import edu.gdpu.zero.framework.common.util.date.DateUtils;
...
import edu.gdpu.zero.framework.tenant.core.util.TenantUtils;
import edu.gdpu.zero.module.system.controller.admin.permission.vo.role.RoleCreateReqVO;
...
import edu.gdpu.zero.module.system.convert.tenant.TenantConvert;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 zero.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
