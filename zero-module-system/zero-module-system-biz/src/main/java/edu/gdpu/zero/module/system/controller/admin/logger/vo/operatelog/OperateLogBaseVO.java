package edu.gdpu.zero.module.system.controller.admin.logger.vo.operatelog;
...
public class OperateLogBaseVO {
    ...
    @Schema(description = "Java 方法名", required = true, example = "edu.gdpu.zero.adminserver.UserController.save(...)")
