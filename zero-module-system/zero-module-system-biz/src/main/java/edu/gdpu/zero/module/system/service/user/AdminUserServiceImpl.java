...
import edu.gdpu.zero.framework.datapermission.core.util.DataPermissionUtils;
...
import edu.gdpu.zero.module.system.convert.user.UserConvert;
...
public class AdminUserServiceImpl implements AdminUserService {
    ...
    @Value("${sys.user.init-password:zeroyuanma}")
