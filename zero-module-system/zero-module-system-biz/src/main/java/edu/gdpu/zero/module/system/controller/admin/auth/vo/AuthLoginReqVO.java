package edu.gdpu.zero.module.system.controller.admin.auth.vo;

import cn.hutool.core.util.StrUtil;
import edu.gdpu.zero.framework.common.validation.InEnum;
...
public class AuthLoginReqVO {
    ...
    @Schema(description = "账号", required = true, example = "zeroyuanma")
