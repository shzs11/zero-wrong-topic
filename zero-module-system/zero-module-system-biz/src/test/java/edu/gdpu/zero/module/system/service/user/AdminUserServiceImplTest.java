package edu.gdpu.zero.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import edu.gdpu.zero.framework.common.enums.CommonStatusEnum;
import edu.gdpu.zero.framework.common.exception.ServiceException;
import edu.gdpu.zero.framework.common.pojo.PageResult;
import edu.gdpu.zero.framework.common.util.collection.ArrayUtils;
import edu.gdpu.zero.framework.common.util.collection.CollectionUtils;
import edu.gdpu.zero.framework.test.core.ut.BaseDbUnitTest;
import edu.gdpu.zero.module.infra.api.file.FileApi;
import edu.gdpu.zero.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import edu.gdpu.zero.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import edu.gdpu.zero.module.system.controller.admin.user.vo.user.*;
import edu.gdpu.zero.module.system.dal.dataobject.dept.DeptDO;
import edu.gdpu.zero.module.system.dal.dataobject.dept.PostDO;
import edu.gdpu.zero.module.system.dal.dataobject.dept.UserPostDO;
...
import edu.gdpu.zero.module.system.dal.mysql.dept.UserPostMapper;
import edu.gdpu.zero.module.system.dal.mysql.user.AdminUserMapper;
import edu.gdpu.zero.module.system.enums.common.SexEnum;
import edu.gdpu.zero.module.system.service.dept.DeptService;
import edu.gdpu.zero.module.system.service.dept.PostService;
import edu.gdpu.zero.module.system.service.permission.PermissionService;
import edu.gdpu.zero.module.system.service.tenant.TenantService;
...
import static edu.gdpu.zero.framework.common.util.collection.SetUtils.asSet;
import static edu.gdpu.zero.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static edu.gdpu.zero.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static edu.gdpu.zero.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static edu.gdpu.zero.framework.test.core.util.AssertUtils.assertPojoEquals;
import static edu.gdpu.zero.framework.test.core.util.AssertUtils.assertServiceException;
import static edu.gdpu.zero.framework.test.core.util.RandomUtils.*;
import static edu.gdpu.zero.module.system.enums.ErrorCodeConstants.*;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("zeroyuanma");
        ...
        assertEquals("zeroyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("zeroyuanma"))).thenReturn("java");
