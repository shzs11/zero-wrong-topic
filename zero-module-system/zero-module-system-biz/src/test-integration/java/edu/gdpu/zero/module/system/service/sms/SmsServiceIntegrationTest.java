...
import edu.gdpu.zero.framework.sms.config.ZeroSmsAutoConfiguration;
import edu.gdpu.zero.module.system.test.BaseDbAndRedisIntegrationTest;
import edu.gdpu.zero.module.system.mq.consumer.sms.SmsSendConsumer;
...
// TODO @芋艿：需要迁移
@Import({ZeroSmsAutoConfiguration.class,
