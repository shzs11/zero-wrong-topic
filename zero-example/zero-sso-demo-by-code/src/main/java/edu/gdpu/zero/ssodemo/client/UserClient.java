package edu.gdpu.zero.ssodemo.client;

import edu.gdpu.zero.ssodemo.client.dto.CommonResult;
import edu.gdpu.zero.ssodemo.client.dto.user.UserInfoRespDTO;
import edu.gdpu.zero.ssodemo.client.dto.user.UserUpdateReqDTO;
