...
import edu.gdpu.zero.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogExportReqVO;
import edu.gdpu.zero.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import edu.gdpu.zero.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import edu.gdpu.zero.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import edu.gdpu.zero.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static edu.gdpu.zero.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static edu.gdpu.zero.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("zero-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("zero-test");
