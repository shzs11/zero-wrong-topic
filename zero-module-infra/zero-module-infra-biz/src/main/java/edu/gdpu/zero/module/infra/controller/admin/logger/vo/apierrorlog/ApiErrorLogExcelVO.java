package edu.gdpu.zero.module.infra.controller.admin.logger.vo.apierrorlog;
...
import edu.gdpu.zero.module.infra.enums.DictTypeConstants;
...
public class ApiErrorLogExcelVO {
    ...
    @DictFormat(edu.gdpu.zero.module.system.enums.DictTypeConstants.USER_TYPE)
