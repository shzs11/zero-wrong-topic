package edu.gdpu.zero.module.infra.service.codegen.inner;
...
import edu.gdpu.zero.framework.common.exception.util.ServiceExceptionUtil;
...
import edu.gdpu.zero.module.infra.framework.codegen.config.CodegenProperties;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "zero-module-${table.moduleName}/" + // 顶级模块
                "zero-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "zero-module-${table.moduleName}/" + // 顶级模块
                "zero-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "zero-ui-${sceneEnum.basePackage}/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "zero-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
}
