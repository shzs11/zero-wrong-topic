...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "edu.gdpu.zero";
    private static final String ARTIFACT_ID = "zero";
    private static final String PACKAGE_NAME = "edu.gdpu.zero";
    private static final String TITLE = "ZERO错题管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "edu.gdpu.zero";
        String artifactIdNew = "zero";
        String packageNameNew = "edu.gdpu.zero";
        String titleNew = "ZERO错题管理系统";
