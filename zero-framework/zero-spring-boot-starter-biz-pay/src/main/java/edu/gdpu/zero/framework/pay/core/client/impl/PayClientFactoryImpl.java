package edu.gdpu.zero.framework.pay.core.client.impl;

import cn.hutool.core.lang.Assert;
import edu.gdpu.zero.framework.pay.core.client.PayClient;
import edu.gdpu.zero.framework.pay.core.client.PayClientConfig;
import edu.gdpu.zero.framework.pay.core.client.PayClientFactory;
import edu.gdpu.zero.framework.pay.core.client.impl.alipay.AlipayPayClientConfig;
import edu.gdpu.zero.framework.pay.core.client.impl.alipay.AlipayPcPayClient;
import edu.gdpu.zero.framework.pay.core.client.impl.alipay.AlipayQrPayClient;
import edu.gdpu.zero.framework.pay.core.client.impl.alipay.AlipayWapPayClient;
import edu.gdpu.zero.framework.pay.core.client.impl.wx.WXLitePayClient;
import edu.gdpu.zero.framework.pay.core.client.impl.wx.WXNativePayClient;
import edu.gdpu.zero.framework.pay.core.client.impl.wx.WXPayClientConfig;
import edu.gdpu.zero.framework.pay.core.client.impl.wx.WXPubPayClient;
import edu.gdpu.zero.framework.pay.core.enums.PayChannelEnum;
