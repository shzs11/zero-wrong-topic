package edu.gdpu.zero.framework.tracer.config;

import edu.gdpu.zero.framework.common.enums.WebFilterOrderEnum;
import edu.gdpu.zero.framework.tracer.core.aop.BizTraceAspect;
import edu.gdpu.zero.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "zero.tracer", value = "enable", matchIfMissing = true)
public class ZeroTracerAutoConfiguration {
