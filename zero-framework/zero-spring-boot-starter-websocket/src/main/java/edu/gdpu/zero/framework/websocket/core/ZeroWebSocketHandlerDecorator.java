package edu.gdpu.zero.framework.websocket.core;
...
public class ZeroWebSocketHandlerDecorator extends WebSocketHandlerDecorator {
    public ZeroWebSocketHandlerDecorator(WebSocketHandler delegate) {
        super(delegate);
    }
