package edu.gdpu.zero.framework.operatelog.core.aop;
...
import edu.gdpu.zero.framework.operatelog.core.enums.OperateTypeEnum;
import edu.gdpu.zero.framework.operatelog.core.service.OperateLog;
import edu.gdpu.zero.framework.operatelog.core.service.OperateLogFrameworkService;
import edu.gdpu.zero.framework.web.core.util.WebFrameworkUtils;
...
import static edu.gdpu.zero.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static edu.gdpu.zero.framework.common.exception.enums.GlobalErrorCodeConstants.SUCCESS;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        edu.gdpu.zero.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                edu.gdpu.zero.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         edu.gdpu.zero.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           edu.gdpu.zero.framework.operatelog.core.annotations.OperateLog operateLog,
