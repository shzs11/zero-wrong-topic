package edu.gdpu.zero.framework.social.core;

import cn.hutool.core.util.EnumUtil;
import cn.hutool.core.util.ReflectUtil;
import edu.gdpu.zero.framework.social.core.enums.AuthExtendSource;
import edu.gdpu.zero.framework.social.core.request.AuthWeChatMiniAppRequest;
 ...
 * @date 2021-10-31
 */
public class ZeroAuthRequestFactory extends AuthRequestFactory {
    ...
    public ZeroAuthRequestFactory(JustAuthProperties properties, AuthStateCache authStateCache) {
